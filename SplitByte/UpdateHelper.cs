...
namespace SplitByte
{
    public class UpdateHelper
    {
        ...
        {
            //3string lastcheck = Properties.Settings.Default.LastCheckVersion;

            string lastcheck = RegistryHelper.GetKeyValue("LastCheckVersion");
            ...
            //3Properties.Settings.Default.LastCheckVersion = DateTime.Now.Month.ToString("D2") + DateTime.Now.Day.ToString("D2") + DateTime.Now.Year.ToString("D4");

            RegistryHelper.SetKeyValue("LastCheckVersion", DateTime.Now.Month.ToString("D2") + DateTime.Now.Day.ToString("D2") + DateTime.Now.Year.ToString("D4"));
        ...
        public static CheckVersionResult CheckVersionBackground()
        {
            ...
            try
            {
                ...
                if (str.Contains("|||"))
                {
                    ...
                    //3Properties.Settings.Default.Price = price;
                }
